        ...
        case "dropDownA":
          const hasPersonalDataReq = await callChatGpt(
            "Consider to be a GDPR expert that needs to analyzing a process, in order to understand if it handles personal data of the Data subject." +
              ...
              currentXML +
              "If the response is positive, print ‘Yes’, otherwise if the process does not handle personal data print or in ANY other case print ‘No’, add a brief motivation for your answer, PRINT JUST THE RESPONSE ONE TIME NOT FOR EACH STEP" +
        ...
        case "dropDownB":
          const hasConsentReq = await callChatGpt(
            "Consider to be a GDPR specialist that needs to understand the level of GDPR compliance of a process. The logical description of the process is this one" +
              ...
              "\n4. Print 'Yes' + an array with the IDs of the activities that require consent before being executed and for which the consent is not already present. Only include IDs of the activities (check the textual description). I must be able to call const arrayMatch = answer.match(/[.*?]/); const array = JSON.parse(arrayMatch); on it" +
              "+\n5. If no activities require consent, print 'No,[]'." +
        ...
        case "dropDownF":
          const hasRightToObjectReq = await callChatGpt(
            "Consider to be a GDPR specialist that needs to understand the level of GDPR compliance of a process by analyzing the logical description of the process and its textual description. The logic description is this one:\n " +
              ...
              " Step3: If the process is not compliant with the , print 'No' as the answer. PRINT JUST THE RESPONSE ONE TIME NOT FOR EACH STEP and a brief motivation. The Right to Object to Automated data processing does not implies that the Right to Object is respected and vice-versa" +
        ...
        case "dropDownG":
          const hasRightToObjectAutomatedProcessingReq = await callChatGpt(
            "Consider to be a GDPR specialist that needs to understand the level of GDPR compliance of a process by analyzing the logical description of the process and its textual description. The logic description is this one:\n " +
              ...
              " You can also print 'Yes' if you find some activity whose name indicates some kind of right to object to automated processing handling. In every other case, including cases of insecurity, print 'No' as the answer. PRINT JUST THE RESPONSE ONE TIME NOT FOR EACH STEP and a brief motivation" +
        ...
        case "dropDownH":
          const hasRightToRestrictProcessingReq = await callChatGpt(
            "Consider to be a GDPR specialist that needs to understand the level of GDPR compliance of a process by analyzing the logical description of the process and its textual description. The logic description is this one:\n " +
              ...
              "\nIf you find this condition, you can print 'Yes' as the answer. You can also print 'Yes' if you find some activity whose name indicates some kind of right to restrict processing handling. In every other case, including cases of insecurity, print 'No' as the answer. PRINT JUST THE RESPONSE ONE TIME NOT FOR EACH STEP and a brief motivation" +
